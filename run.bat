...
SET WS_DIR=Workspace7
SET REPO_NAME=Title_Validation_CSV
SET APP_VERSION=1.1
SET MAIN_CLASS=core.HtmlUnit_csv_try
SET ARGS_01=
::========================================
...
java -jar C:\%WS_DIR%\%REPO_NAME%\%REPO_NAME%\target\Title_Validation_CSV-1.1-jar-with-dependencies.jar 
GOTO END
